...
TOKEN = os.environ.get("BOT_TOKEN", "7614027614:AAE792IMXf4MSMzRl9Io37TSVtsKb4PPKJc")

# Bot owner/admin information
ADMIN_ID = int(os.environ.get("ADMIN_ID", "8011959413"))
BOT_USERNAME = os.environ.get("BOT_USERNAME", "@EASYNAME69")
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    watermark = f"📌 @EASYNAME69 | {datetime.now().strftime('%Y-%m-%d')}"
